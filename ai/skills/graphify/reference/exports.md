# graphify reference: optional exports (Step 7)

Read this file during the main pipeline's Step 7 only if `--neo4j`, `--neo4j-push`, `--svg`, `--graphml`, or `--mcp` was given on the invocation. Otherwise Step 7 is a no-op.

### Neo4j export - if --neo4j
